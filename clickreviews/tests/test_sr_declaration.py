...
''')
    ...
    def test_check_declaration_plugs_unity8(self):
        '''Test check_declaration - plugs unity8'''
        plugs = {'iface': {'interface': 'unity8'}}
        self.set_test_snap_yaml("plugs", plugs)
        c = SnapReviewDeclaration(self.test_name)
        ...
        expected['warn'] = dict()
        expected['info'] = dict()
        name = 'declaration-snap-v2:plugs:iface:unity8'
        expected['info'][name] = {"text": "OK"}
        self.check_results(r, expected=expected)

    def test_check_declaration_slots_unity8(self):
        '''Test check_declaration - slots unity8'''
        slots = {'iface': {'interface': 'unity8'}}
        self.set_test_snap_yaml("slots", slots)
        self.set_test_snap_yaml("type", "app")
        c = SnapReviewDeclaration(self.test_name)
